    ...
    <fieldset class="border border-slate-200 rounded-lg px-4 py-2">
            ...
            <div class="flex gap-4 my-4">
                <div class="flex flex-col gap-2">
                    ...
                    <input id="input" type="text" name="firstname" id="firstname" placeholder="Martin" value="Martine" minlength="2" maxlength="80" class="border border-slate-200 rounded-lg px-4 py-2 focus:border-slate-400 focus:shadow-md focus:outline-none" required>
                </div>
                <div class="flex flex-col gap-2">
                    <label for="lastname" class="font-semibold text-lg">Votre nom</label>
                    <input id="input" type="text" name="lastname" id="lastname" placeholder="Dupont" value="Dupont" minlength="2" maxlength="80" class="border border-slate-200 rounded-lg px-4 py-2 focus:border-slate-400 focus:shadow-md focus:outline-none" required>
                </div>
            </div>
    </fieldset>
        <!-- Contact -->
    <fieldset class="border border-slate-200 rounded-lg px-4 py-2">
            ...
            <div class="flex gap-4 my-4">
                <div class="flex flex-col gap-2">
                    ...
                    <input id="input" type="email" name="email" id="firstname" placeholder="martin@gmail.com" value="martin@gmail.com" maxlength="80" class="border border-slate-200 rounded-lg px-4 py-2 focus:border-slate-400 focus:shadow-md focus:outline-none" required>
                </div>
                <div class="flex flex-col gap-2">
                    <label for="telephone" class="font-semibold text-lg">Téléphone</label>
                    <input id="input" type="tel" name="telephone" id="lastname" placeholder="0612345678" value="0612345678" minlength="10" maxlength="12" class="border border-slate-200 rounded-lg px-4 py-2 focus:border-slate-400 focus:shadow-md focus:outline-none" required>
                </div>
            </div>
    </fieldset>
        <!-- Message -->
        <div class="flex flex-col gap-2 mt-2">
            ...
            focus:border-slate-400 focus:shadow-md focus:outline-none"></textarea>
        </div>
        <button type="submit" class="w-40 text-center bg-white text-slate-800 rounded-lg 
        shadow-md p-2 mt-4 hover:text-white hover:bg-slate-800 flex gap-2 items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="#000000" d="m2 21l21-9L2 3v7l15 2l-15 2z"/></svg>    
            Envoyer
        </button>
</form>
</div>