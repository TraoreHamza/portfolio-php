<div class="m-4 shadow-sm">
    <form action="" method="post" class="flex flex-col gap-3">
        ...
        <fieldset class="border-2 border-slate-950 rounded-lg px-4 py-2">
            <legend class="flex gap-2 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path fill="#707070" d="M19 19H5V5h14m0-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2m-2.5 13.25c0-1.5-3-2.25-4.5-2.25s-4.5.75-4.5 2.25V17h9M12 12.25A2.25 2.25 0 0 0 14.25 10A2.25 2.25 0 0 0 12 7.75A2.25 2.25 0 0 0 9.75 10A2.25 2.25 0 0 0 12 12.25" />
                </svg>
                Vous êtes ?
            </legend>
        ...
        <div class="">
            ...
            border-slate-950 rounded-lg px-4 py-2 bg-amber-50 focus:shadow-md 
            focus:outline-none" placeholder="Votre message..." required minlength="100"></textarea>
            <p class="text-xs text-slate-400 mt-2">
                <span id="message-length">0</span> sur 100 caractères.
            </p>
        </div>

        <button type="submit" class="w-fit text-center bg-white text-slate-800 rounded-lg 
        shadow-md p-2 mt-4 hover:text-white hover:bg-slate-800 flex gap-2 items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path fill="#000000" d="m2 21l21-9L2 3v7l15 2l-15 2z" />
            </svg>
            Envoyer
        </button>
    </form>
